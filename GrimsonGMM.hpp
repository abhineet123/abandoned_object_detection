...
public:
	...
	void Subtract2(const RgbImage& data,  
...
private:
    ...
    void SubtractPixel2(long posPixel, const RgbPixel& pixel, unsigned char& numModes,
                        unsigned char& lowThreshold, unsigned char& highThreshold,
						unsigned char& static_mask_value,double static_threshold,bool update_model);

    void rearrangeDistributions(long posPixel,unsigned char numModes);
